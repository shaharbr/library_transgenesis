#!/usr/bin/env python3
"""
Analyze raw 7462 library to identify barcodes expected to integrate multiple times.
...
Usage:
    python analyze_raw_7462_library.py <extracted_barcodes_7462.pkl>
"""
...
def analyze_raw_library(library_file, avg_barcodes_per_fish=3000, n_fish=12):
    ...
    print("="*80)
    print("RAW 7462 LIBRARY ANALYSIS")
    print("="*80)
    print()
...
def plot_library_analysis(all_rpms, rpm_threshold, high_abundance_barcodes):
    ...
    output_file = f'raw_7462_library_analysis_{timestamp}.png'
...
def main():
    if len(sys.argv) < 2:
        ...
        print()
        print("Usage:")
        print("  python analyze_raw_7462_library.py <extracted_barcodes_7462.pkl>")
        print()
        ...
        print()
        print("Example:")
        print("  python analyze_raw_7462_library.py extracted_barcodes_7462_*.pkl")
        print("  python analyze_raw_7462_library.py extracted_barcodes_7462_*.pkl --avg-barcodes-per-fish 2500")
        return
